...
class AgentRouter:
    ...
    def __init__(self, memory_id: Optional[str] = None, region_name: str = 'us-east-1'):
        ...
        self.model_config = BedrockModel(
            model_id=self.models['router']['id']
        )
    ...
    def _setup_memory(self, memory_id: str, session_id: Optional[str] = None, actor_id: Optional[str] = None):
        """
